<script lang="ts">
	//Local components
	import DatatableClient from '$lib/components/client/DatatableClient.svelte';
	//Skeleton components
	import {
		CodeBlock,
		RadioGroup,
			...
			{#if tabSet === 0}
				<div class="card overflow-hidden py-4 px-2">
					<header class="ml-2 mt-2">
						<h3 class="h3 text-primary-500">Search</h3>
			...
			{:else if tabSet === 1}
				<div class="card overflow-hidden py-4 px-2">
					<header class="mx-4 space-y-2">
						<h3 class="h3 text-primary-500">Pagination</h3>
