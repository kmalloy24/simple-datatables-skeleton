	...
	<svelte:fragment slot="header">
		...
		<AppBar gridColumns="grid-cols-3" slotDefault="place-self-center" slotTrail="place-content-end">
			...
			<svelte:fragment slot="lead">
				<span class="flex">
					<a href="https://www.skeleton.dev/" class="btn btn-icon ml-2" target="_blank">
						<svg
					...
					<strong
						class="text-4xl mx-4 bg-gradient-to-br from-primary-500 to-tertiary-500 bg-clip-text text-transparent box-decoration-clone"
					>
						X
					</strong>
					<a href="https://vincjo.fr/datatables/home" target="_blank">
						<img
							class="h-10"
							src="https://vincjo.fr/datatables/logo.svg"
							alt="svelte simple datatables"
						/>
					</a>
				</span>
			</svelte:fragment>
			...
			<svelte:fragment slot="trail">
				<a href="https://github.com/kmalloy24/simple-datatables-skeleton" target="_blank">
					<img class="h-8 mr-2" src="/github.png" alt="github" />
				</a>
			</svelte:fragment>
		</AppBar>
	</svelte:fragment>
